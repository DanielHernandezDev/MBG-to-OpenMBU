...
{
  baseShape = "~/data/shapes_mbu/astrolabe/astrolabe.dts";
  sequence0 = "~/data/shapes_mbu/astrolabe/astrolabe_root.dsq root";
};
...
datablock StaticShapeData(astrolabeShape)
{
   className = "astrolabe";
   category = "Misc";
   shapeFile = "~/data/shapes_mbu/astrolabe/astrolabe.dts";
   scopeAlways = true;
   sortLast = true;
   astrolabe = true;
...
datablock StaticShapeData(astrolabeCloudsBeginnerShape)
{
   className = "clouds";
   category = "Misc";
   shapeFile = "~/data/shapes_mbu/astrolabe/astrolabe_clouds_beginner.dts";
   scopeAlways = true;
   astrolabe = true;
   astrolabePrime = true;
};
...
datablock StaticShapeData(astrolabeCloudsIntermediateShape)
{
   className = "clouds";
   category = "Misc";
   shapeFile = "~/data/shapes_mbu/astrolabe/astrolabe_clouds_intermediate.dts";
   scopeAlways = true;
   astrolabe = true;
   astrolabePrime = true;
};
...
datablock StaticShapeData(astrolabeCloudsAdvancedShape)
{
   className = "clouds";
   category = "Misc";
   shapeFile = "~/data/shapes_mbu/astrolabe/astrolabe_clouds_advanced.dts";
   scopeAlways = true;
   astrolabe = true;
   astrolabePrime = true;
};
...
datablock StaticShapeData(glass_3shape)
{
   className = "glass_3";
   category = "structures";
   shapeFile = "~/data/shapes_mbu/structures/glass_3.dts";
   scopeAlways = true;
   glass = true;
};
...
datablock StaticShapeData(glass_6shape)
{
   className = "glass_6";
   category = "structures";
   shapeFile = "~/data/shapes_mbu/structures/glass_6.dts";
   scopeAlways = true;
   glass = true;
};
...
datablock StaticShapeData(glass_9shape)
{
   className = "glass_9";
   category = "structures";
   shapeFile = "~/data/shapes_mbu/structures/glass_9.dts";
   scopeAlways = true;
   glass = true;
};
...
datablock StaticShapeData(glass_12shape)
{
   className = "glass_12";
   category = "structures";
   shapeFile = "~/data/shapes_mbu/structures/glass_12.dts";
   scopeAlways = true;
   glass = true;
};
...
datablock StaticShapeData(glass_15shape)
{
   className = "glass_15";
   category = "structures";
   shapeFile = "~/data/shapes_mbu/structures/glass_15.dts";
   scopeAlways = true;
   glass = true;
};
...
datablock StaticShapeData(glass_18shape)
{
   className = "glass_18";
   category = "structures";
   shapeFile = "~/data/shapes_mbu/structures/glass_18.dts";
   scopeAlways = true;
   glass = true;
};
...
datablock StaticShapeData(glass_flat)
{
   ...
   category = "structures";
   shapeFile = "~/data/shapes_mbu/structures/glass_flat.dts";
   scopeAlways = true;
   glass = true;
};
